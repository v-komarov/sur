...
import apps.cabinet.authorize
from apps.cabinet import views_confirm, roadside_confirm, ajax, views_overlord, authorize
...
urlpatterns = [
    ...
    url(r'^auth/$', authorize.index),
    url(r'^logout/$', authorize.cabinet_logout),
    url(r'^get_access/$', authorize.get_access),
    url(r'^get_restore/$', authorize.get_restore),
