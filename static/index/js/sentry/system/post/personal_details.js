...
function userDetailsEdit(user_id){
    ...
    if(user_id=='add'){
        ...
        $.ajax({ url:'/system/post/personal/ajax/get/', type:'get', dataType:'json',
...
function userDetailsSave() {
    ...
    $.ajax({ url:'/system/post/personal/ajax/save/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
...
function userDetailsRemove(user_id) {
    $.ajax({ url:'/system/post/personal/ajax/remove/', type:'post', dataType:'json', data:{ 'user_id':user_id },
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
