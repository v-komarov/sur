...
function shiftMultipleSave(shift) {
    ...
    $.ajax({ url:'/system/post/timetable/set_multi_shift/', type:'post', dataType:'json', data:ajax_array,
...
function shiftSave(shift) {
    ...
    $.ajax({ url:'/system/post/timetable/set_shift/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']) {
                alert(data['error']);
            } else {
