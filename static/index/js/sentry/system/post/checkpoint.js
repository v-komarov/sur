...
function ajaxSearch() {
    ...
    $.ajax({ url:'/system/post/checkpoint/ajax/get/', type:'get', dataType:'json', data:ajax_array ,
...
function setTable(data) {
    ...
    for(var key in arrival){
        var tr = '<tr class="row" post_id="'+ arrival[key]['post_id'] +'" armed="'+ arrival[key]['armed'] +'">' +
            ...
            '<a class="href_block" href="/system/post/timetable/?year='+arrival[key]['year']+'&month='+arrival[key]['begin_date'].slice(3,5)+'&service_id='+arrival[key]['service_id']+'">' +
            ...
            '<a class="href_block" href="/system/post/personal/?user_id='+arrival[key]['user_id']+'">' +
    ...
    for(var key in watch){
        var tr = '<tr class="row" post_id="'+ watch[key]['post_id'] +'" armed="'+ watch[key]['armed'] +'" ' +
            ...
            '<a class="href_block" href="/system/post/timetable/?year='+watch[key]['year']+'&month='+watch[key]['begin_date'].slice(3,5)+'&service_id='+watch[key]['service_id']+'">' +
            ...
            '<a class="href_block" href="/system/post/personal/?user_id='+watch[key]['user_id']+'">' +
    ...
    for(var key in completed){
        var tr = '<tr class="row" post_id="'+ completed[key]['post_id'] +'" armed="'+ completed[key]['armed'] +'" ' +
            ...
            '<a class="href_block" href="/system/post/timetable/?year='+completed[key]['year']+'&month='+completed[key]['begin_date'].slice(3,5)+'&service_id='+completed[key]['service_id']+'">' +
            ...
            '<a class="href_block" href="/system/post/personal/?user_id='+completed[key]['user_id']+'">' +
