...
function userCardStatusRemove(status_id){
    $.ajax({ url:'/post/personal/ajax/card_status_remove/', type:'post', dataType:'json', data:{'status_id':status_id},
...
function userCardStatusSave(){
    ...
    $.ajax({ url:'/post/personal/ajax/card_status_save/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
...
function userCardEdit(user_id,card_id){
    ...
    if(card_id=='add'){
        ...
        $.ajax({ url:'/post/personal/ajax/get_card/', type:'get', dataType:'json', data:{'user_id':user_id,'card_id':card_id},
            success: function(data){
                if(data['error']!=null){
                    alert(data['error']);
                    $('.loading').hide();
...
function userCardRemove(user_id,card_id) {
    ...
    $.ajax({ url:'/post/personal/ajax/card_remove/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
...
function userCardSave() {
    ...
    $.ajax({ url:'/post/personal/ajax/card_save/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
