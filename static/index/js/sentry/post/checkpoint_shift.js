...
function clickButton(tr,action) {
    ...
    if(action=='arrival') {
        $.ajax({ url:'/post/checkpoint/ajax/shift_by_plan/', type:'post', dataType:'json', data:ajax_array,
        ...
        $.ajax({ url:'/post/checkpoint/ajax/'+action_+'/', type:'post', dataType:'json', data:ajax_array,
            success: function(data){
                ajaxSearch();
            }
        });
...
function userSelect() {
    ...
    $.ajax({ url:'/post/timetable/get_users/', type:'get', dataType:'json', data:ajax_array,
        success: function(data){
