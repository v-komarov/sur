...
function userWeaponEdit(user_id, weapon_id){
    ...
    if(weapon_id == 'add') {
        ...
        $.ajax({ url:'/post/personal/ajax/get_weapon/', type:'get', dataType:'json', data:{'user_id':user_id,'weapon_id':weapon_id},
...
function userWeaponSave() {
    ...
    $.ajax({ url:'/post/personal/ajax/weapon_save/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
...
function userWeaponRemove(user_id,weapon_id) {
    var ajax_array = {};
    ajax_array['weapon_id'] = weapon_id;
    $.ajax({ url:'/post/personal/ajax/weapon_remove/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
