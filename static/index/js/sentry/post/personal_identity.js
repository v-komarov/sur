...
function userIdentityEdit(user_id,identity_id) {
    ...
    if(identity_id == 'add') {
        ...
        $.ajax({ url: '/post/personal/ajax/get_identity/', type: 'get', dataType: 'json',
...
function user_identity_Update() {
    ...
    $.ajax({ url:'/post/personal/ajax/identity_update/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
...
function userIdentityRemove(user_id,identity_id) {
    var ajax_array = {};
    ajax_array['identity_id'] = identity_id;
    $.ajax({ url:'/post/personal/ajax/identity_remove', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
