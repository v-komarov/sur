...
function userCertificateСheckRemove(check_id){
    $.ajax({ url:'/post/personal/ajax/certificate_check_remove/', type:'post', dataType:'json', data:{'check_id':check_id},
...
function userCertificateСheckSave(){
    ...
    $.ajax({ url:'/post/personal/ajax/certificate_check_save/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
...
function userCertificateEdit(user_id,certificate_id){
    ...
    if(certificate_id == 'add') {
        ...
        tr.attr('class','row hover');
        $.ajax({ url:'/post/personal/ajax/get_certificate/', type:'get', dataType:'json', data:{'user_id':user_id,'certificate_id':certificate_id},
            success: function(data){
                if(data['error']!=null){
                    alert(data['error']);
                    $('.loading').hide();
...
function userCertificateSave() {
    ...
    $.ajax({ url:'/post/personal/ajax/certificate_save/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
...
function userCertificateRemove(user_id,certificate_id) {
    ...
    var ajax_array = {};
    ajax_array['certificate_id'] = certificate_id;
    $.ajax({ url:'/post/personal/ajax/certificate_remove/', type:'post', dataType:'json', data:ajax_array,
        success: function(data){
            if(data['error']!=null){
                alert(data['error']);
            } else {
